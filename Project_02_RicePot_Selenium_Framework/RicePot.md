...
This project is an enterprise-grade automation framework for the Salesforce Login page (`login.salesforce.com`), built using **Selenium WebDriver**, **Java**, **TestNG**, and **Maven**. It utilizes the **Page Object Model (POM)** design pattern with **PageFactory**.
